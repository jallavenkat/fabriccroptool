...
<style type="text/css">
.imCls{margin:5px;border:1px solid #111;width:100%;height:180px;}
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-12">
			...
			?>
			<div class="col-sm-2">
				<a href="viewfabricpieces.php?folder=<?php echo @$img;?>"><i class="fa fa-folder" style="font-size:40px;"></i> <?php echo @$img;?></a>
			</div>
			<?php	
			}
			?>
